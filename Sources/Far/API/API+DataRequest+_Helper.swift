...
extension API {
    ...
    /// context
    func _context(file: Swift.StaticString, line: Swift.UInt) -> Settings.API.Modified {
        let ctx = Settings.API.Modified(requestLocation: Location(file, line))
...
extension API {
    ...
    /// request encoding
    func _request(parameters: Parameters?, context: Settings.API.Modified) -> Alamofire.DataRequest
...
extension API {
    ...
    /// request modify
    func _requestModify(request: Alamofire.DataRequest, context: Settings.API.Modified) {
        // authentication
...
extension API {
    ...
    /// response modify
    func _responseModify(request: Alamofire.DataRequest, context: Settings.API.Modified) {
        // validation
...
extension API {
    ...
    /// async response data
    func _response(request: Alamofire.DataRequest,
                   context: Settings.API.Modified) async -> Alamofire.DataResponse<Returns, AFError>
    where Returns == Foundation.Data {
        let serializer = Settings.API._dataResponseSerializer(context: context)
...
extension API {
    ...
    func _requestAccessing(request: Alamofire.DataRequest, context: Settings.API.Modified) {
        // onRequestAvailable
